...
const EditNoteModal = ({ dark, isOpen, onRequestClose, note }) => {
  ...
  return (
    <Modal isOpen={isOpen} onRequestClose={onRequestClose} className={`flex items-center justify-center mt-[200px] ml-[40px]`}>
      <div className={`p-6 rounded-md shadow-lg w-full max-w-md ${dark ? "bg-black" : "bg-white"}`}>
